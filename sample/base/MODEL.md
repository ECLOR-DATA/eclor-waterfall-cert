# ECLOR — reference base (data model + theme)

> **The reference base for every demo report, screenshot and listing asset of
> this visual.** Extracted 2026-08-09 from the pbix submitted & published with
> the 1.1.76.0 AppSource listing.
>
> The built sample that ships with the listing is
> [../demo-report/eclor_waterfall.pbix](../demo-report/); its reviewable
> source is `../demo-report/eclor_waterfall.pbip`.
>
> Local paths in this folder are sanitized for publication: the workbook is
> located through the **`DataFolder`** parameter (Transform data → Manage
> parameters), which ships with a neutral default.
